...
Controller.prototype.updateFilterState = function () {
  ...
  var activeRouter = currentPage.charAt(0).toUpperCase() + currentPage.substring(1);
...
function Store(name) {
  this.dbName = name;
  if (!(0,_util_helper_js__WEBPACK_IMPORTED_MODULE_0__.localRead)(name)) {
    var todos = [];
    (0,_util_helper_js__WEBPACK_IMPORTED_MODULE_0__.localSave)(name, todos);
  }
}
...
Store.prototype.dropItemsSave = function (currentPage) {
  if (currentPage === 'All') {
    ...
    var _todos = this.readAll(this.dbName);
    var state = currentPage !== 'Active';
    var deletedTodos = _todos.filter(function (v) {
      return v.completed !== state;
    });
    (0,_util_helper_js__WEBPACK_IMPORTED_MODULE_0__.localSave)(this.dbName, deletedTodos);
  }
};
...
/* harmony export */   "localRead": () => (/* binding */ localRead),
